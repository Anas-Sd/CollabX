      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-white/60 leading-relaxed font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
            ...
            <div className="bg-[#0A0A0F] p-8 rounded-3xl border border-white/5 flex flex-col items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:support@collabx.example.com" className="text-[#F5A623] hover:underline font-bold">support@collabx.com</a>
              </div>
            </div>
            ...
            <div className="bg-[#0A0A0F] p-8 rounded-3xl border border-white/5 flex flex-col items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white/80 font-bold">+1 (555) 123-4567</p>
              </div>
            </div>
          ...
          <div className="pt-8 border-t border-white/5 mt-8">
            ...
            <p>If you are a security researcher and believe you have found a vulnerability in our infrastructure or WebSockets implementation, please do not disclose it publicly. Contact us immediately at <span className="text-white font-bold">security@collabx.example.com</span>. We offer bug bounties for responsible disclosure.</p>
          </div>
